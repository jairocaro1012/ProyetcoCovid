...
try:
   cnx = mysql.connector.connect(user='root', password='1234', database='segimiento', host='127.0.0.1')
   cursor = cnx.cursor()
   print('Conectado')
...
Colombia.save("C:\\Users\\jacar\\OneDrive\\Documentos\\python\\señales\\Colombia.html")
...
Bogota.save("C:\\Users\\jacar\\OneDrive\\Documentos\\python\\señales\\Bogota.html")
